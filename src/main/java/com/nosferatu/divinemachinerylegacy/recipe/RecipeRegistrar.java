...
/** DML-native 1.7.10 progression for machines, catalysts and Greenhouse upgrades. */
public final class RecipeRegistrar {
    ...
    private static void registerGreenhouseUpgrades() {
        // Parallel flower capacity: 1 -> 4 -> 16 -> 32 -> 64.
        ...
        // Heat is a separate eighth slot; keep it expensive enough to be a late Greenhouse choice.
        GameRegistry.addRecipe(new ItemStack(DivineMachineryLegacy.greenhouseHeatUpgrade),
                "bcb", "csc", "bcb",
                'b', Items.blaze_powder, 'c', DivineMachineryLegacy.materialIngots[2], 's', DivineMachineryLegacy.materialDragonstones[2]);
    }
