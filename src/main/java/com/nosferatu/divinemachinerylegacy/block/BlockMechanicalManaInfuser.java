...
public class BlockMechanicalManaInfuser extends BlockContainer {
    private static int renderId;
    @SideOnly(Side.CLIENT) private IIcon[] tierIcons;

    public BlockMechanicalManaInfuser() {
        super(Material.rock);
        setBlockName(DivineMachineryLegacy.MODID + ".mechanical_mana_infuser");
        setHardness(4F);
        setResistance(10F);
        setLightOpacity(0);
    ...
    @Override public TileEntity createNewTileEntity(World world, int meta) { return new TileMechanicalManaInfuser(); }
    ...
    public IIcon getInnerStoneIcon(int meta) {
        switch (MachineTier.fromMeta(meta)) {
            case SAFFRON: return ModBlocks.livingrock.getIcon(1, 0);
            case SHADOW: return ModFluffBlocks.biomeStoneA.getIcon(1, 7);
            case CRIMSON: return ModBlocks.shimmerrock.getIcon(1, 0);
            default: return ModFluffBlocks.biomeStoneA.getIcon(1, 1);
        }
    }
    @SideOnly(Side.CLIENT) public IIcon getLapisIcon() { return Blocks.lapis_block.getIcon(1, 0); }
    @SideOnly(Side.CLIENT) public IIcon getCoreIcon() { return ModBlocks.manaGlass.getIcon(1, 0); }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player,
        ...
        if (!world.isRemote) player.openGui(DivineMachineryLegacy.INSTANCE,
                DivineMachineryLegacy.GUI_MANA_INFUSER, world, x, y, z);
        return true;
    }
